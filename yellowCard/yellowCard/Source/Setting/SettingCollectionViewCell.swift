...
class SettingCollectionViewCell: RootCollectionViewCell {
    static let registerId = "SettingCollectionViewCell"
    ...
    override func setupTapped() {
        ...
        self.myCardSetting.addTarget(self, action: #selector(myCardSettingTapped), for: .touchUpInside)
    }
...
extension SettingCollectionViewCell {
    ...
    @objc
    private func myCardSettingTapped() {
        delegate?.myCardSettingTapped()
    }
}
